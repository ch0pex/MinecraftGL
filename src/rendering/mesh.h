...
constexpr Vertex kFaceFront[4] = {
        {{0.0f, 0.0f, 1.0f}, {0.5f, 0.5f, 1.0f}, {1.0f, 0.5f, 0.5f}, {0.0f, 1.0f}}, //0
        {{0.0f, 1.0f, 1.0f}, {0.5f, 0.5f, 1.0f}, {0.5f, 1.0f, 0.5f}, {0.0f, 0.0f}}, //1
        {{1.0f, 1.0f, 1.0f}, {0.5f, 0.5f, 1.0f}, {0.5f, 0.5f, 1.0f}, {1.0f, 0.0f}}, //2
        {{1.0f, 0.0f, 1.0f}, {0.5f, 0.5f, 1.0f}, {1.0f, 0.5f, 1.0f}, {1.0f, 1.0f}}  //3
};
...
constexpr Vertex kFaceBack[4] = {
        ...
        {{0.0f, 0.0f, 0.0f}, {0.5f, 0.5f, 0.0f}, {1.0f, 0.5f, 1.0f}, {1.0f, 1.0f}}  //7
};
